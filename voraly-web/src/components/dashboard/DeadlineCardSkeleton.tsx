  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-4">
        <div>
          <div className="text-sm font-bold text-theme-primary">⚡ Urgences &amp; Deadlines</div>
          <div className="text-[11px] text-theme-muted mt-0.5">Livraisons imminentes</div>
        </div>
      </div>

      <div className="flex flex-1 flex-col items-center justify-center gap-3 py-10">
        <div className="h-10 w-10 animate-pulse rounded-2xl border border-theme bg-white/[0.05]" />
